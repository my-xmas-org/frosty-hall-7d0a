...
```
npm create cloudflare@latest -- --template=cloudflare/templates/frosty-hall-7d0a
```

## Preview Deployment

A live public deployment of this template is available at [https://frosty-hall-7d0a.templates.workers.dev](https://frosty-hall-7d0a.templates.workers.dev)
